...
import { InscritoAoEventoPage } from "./pages/inscritos-evento/InscritoAoEventoPage";
        ...
        <Routes>
          <Route path="/main" element={<Out />}>
            ...
            {permissoes.includes('manage.eventos') &&
              <>
                <Route path="agenda-eventos" element={<AgendaEventosPage />} />
                 <Route path=":id/eventos/inscritos" element={<InscritoAoEventoPage />} />
